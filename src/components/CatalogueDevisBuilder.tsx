          ...
          <div className="mt-4 space-y-3">
            {results.map((article) => {
              ...
              return (
                <div
                  key={article.code}
                  className={`group flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-2xl border bg-white p-4 sm:p-5 transition-all hover:shadow-md ${
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap items-center gap-2 mb-1.5">
                      <span className="font-mono text-xs font-black text-ink bg-slate-100 px-2.5 py-0.5 rounded border border-slate-200">
                        {article.code}
                      </span>
                      <span className="text-[11px] font-semibold text-ink-soft uppercase tracking-wider bg-slate-50 px-2 py-0.5 rounded truncate max-w-[280px] sm:max-w-none">
                        {article.rayon} &gt; {article.famille}
                      </span>
                    </div>
                    <h4 className="font-display text-sm sm:text-base font-bold text-ink leading-snug break-words">
                      {article.designation}
                    </h4>
                    <div className="mt-2 flex items-baseline gap-3">
                      <span className="font-display text-lg font-black text-orsap-red">
